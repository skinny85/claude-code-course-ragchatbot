...
"""
    ...
    def generate_response(self, query: str,
        ...
        while True:
            ...
            if response.stop_reason == "tool_use" and tool_manager and current_round <= self.MAX_ROUNDS:
    ...
    def _handle_tool_execution(self, initial_response, current_messages: List, tool_manager):
        """
